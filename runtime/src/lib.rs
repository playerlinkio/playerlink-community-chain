...
use sp_runtime::{
	...
	ApplyExtrinsicResult, FixedPointNumber, FixedU128, MultiSignature, Perquintill, Percent,
};
use sp_std::prelude::*;
#[cfg(feature = "std")]
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	...
	impl_name: create_runtime_str!("playerlink-node"),
	authoring_version: 1,
...
parameter_types! {
    ...
    pub const VotingBond: Balance = PL / 100;
...
parameter_types! {
    pub const BasicDeposit: Balance = 10 * PL;       // 258 bytes on-chain
    pub const FieldDeposit: Balance = 250 * CENTS;        // 66 bytes on-chain
    pub const SubAccountDeposit: Balance = 2 * PL;   // 53 bytes on-chain
...
parameter_types! {
    ...
    // 10 PL
    pub const MinimumDeposit: Balance = 1000 * PL;
...
parameter_types! {
    ...
    // 10 PL
    pub const ProposalBondMinimum: Balance = 1000 * PL;
    pub const SpendPeriod: BlockNumber = 6 * DAYS;
    pub const NoBurn: Permill = Permill::from_percent(0);
    pub const TipCountdown: BlockNumber = 1 * DAYS;
    pub const TipFindersFee: Percent = Percent::from_percent(20);
    pub const TipReportDepositBase: Balance = 1 * PL;
    pub const DataDepositPerByte: Balance = 1 * CENTS;
    pub const BountyDepositBase: Balance = 1 * PL;
    pub const BountyDepositPayoutDelay: BlockNumber = 4 * DAYS;
    pub const TreasuryPalletId: PalletId = PalletId(*b"pl/trsuy");
    pub const BountyUpdatePeriod: BlockNumber = 90 * DAYS;
    pub const MaximumReasonLength: u32 = 16384;
    pub const BountyCuratorDeposit: Permill = Permill::from_percent(50);
    pub const BountyValueMinimum: Balance = 10 * PL;
