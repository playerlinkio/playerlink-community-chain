...
use sp_runtime::{
	...
	ApplyExtrinsicResult, FixedPointNumber, FixedU128, MultiSignature, Percent, Perquintill,
};
use sp_std::prelude::*;
#[cfg(feature = "std")]
...
parameter_types! {
	// 10 PL
	pub const CandidacyBond: Balance = 100 * PL;
...
parameter_types! {
	...
	pub const TreasuryPalletId: PalletId = PalletId(*b"py/trsuy");
